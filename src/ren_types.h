...
constexpr v4 CLR_MINT          = {0.243f, 0.706f, 0.537f, 1.0f};
...
constexpr v4 CLR_MINT_BLUE     = {0.259f, 0.62f, 0.616f, 1.0f};
constexpr v4 CLR_NAVY_BLUE     = {0.0f, 0.0f, 0.502f, 1.0f};
...
constexpr v4 CLR_EMERALD_GREEN = {0.314f, 0.784f, 0.471f, 1.0f};
